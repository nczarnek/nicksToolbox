...
% 11 August 2014
%
% extractRawEnergyFeaturesFromAggregate.m
...
function energyFeats = extractRawEnergyFeaturesFromAggregate(ds,eventTimes,halfWindowInS,varargin)
  ...
  if removeBaseline
    for eInc = 1:size(eventTimes(fInc).onEventsTimes,1)
      try
        ...
        currentFeats  = ds.data(midPoint - halfWindowLength:midPoint + halfWindowLength,1)';
